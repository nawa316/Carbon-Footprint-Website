    ...
    <div className="min-h-screen bg-[#111] text-white p-10 pt-28 font-urbanist">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-5xl font-bold text-center mb-10">
          SustainaTrack <span className="text-green-500">Quiz Leaderboard</span>
        </h1>

        {loading ? (
          <p className="text-center text-green-200 text-xl">Memuat data quiz champions...</p>
        ) : (
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-[#111] border-b border-green-500/30">
                  ...
                  <th className="p-5 text-green-500 font-semibold text-lg text-right">Poin Quiz</th>
                </tr>
              </thead>
              <tbody>
                {leaders.length > 0 ? (
                  leaders.map((item, index) => (
                    ...
                    >
                      ...
                      <td className="p-5 font-medium text-lg">
                        {item.username || item.name || 'Pengguna'}
                      </td>
                  ...
                  <tr>
                    <td colSpan="3" className="text-center p-10 text-gray-400">
                      Belum ada data poin quiz yang tersimpan.
                    </td>
                  </tr>
                )}
              </tbody>
